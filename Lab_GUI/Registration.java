...
class MyFrame
	...
	// with default values.
	public MyFrame() {
		setTitle("Adarsh's Registration Form");
		...
		delete.setLocation(340, 450);
		delete.addActionListener(this);
		c.add(delete);

		String column[] = { "NAME", "MOBILE", "GENDER", "DOB", "ADDRESS" };
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == sub) {
			...
			for (int i = 0; i < tout.getRowCount(); i++) {
				String rowEntry = tout.getValueAt(i, 0).toString();
				if (rowEntry.equalsIgnoreCase(tname.getText())) {
					model.removeRow(i);
					break;
				}
			}
